...
//		if(str.matches(".*[a-c].*")) {//[abc]---> 내방식 이건 안된다. 왜 안되는지 고민할것       .*[a-c].*	이건됨
//			System.out.println("매칭");
//		}else {
//			System.out.println("비매칭");
//		}
...
//		}
		...
		// 이메일 관련 검증
//		if(str.matches("[^0-9]*[\\w]+@[a-zA-Z0-9]+(.[\\w]+)")) {
//			System.out.println("매칭");
//		}else {
//			System.out.println("비매칭");
//		}
		...
		// 이메일 관련 검증
//		if (str.matches("^[\\D]\\w+@\\w+\\.\\w{2,3}$")) {// . 은 문법적의미가 있어서 \\. 이렇게 써야함.
//			System.out.println("매칭");
//		} else {
//			System.out.println("비매칭");
//		}
		...
		// 일반, 이미지 파일 식별
//		if (str.matches("^[\\w]+\\.jpg")) {// . 은 문법적의미가 있어서 \\. 이렇게 써야함. 문자열 . 이 된다.
//			System.out.println("jpg 매칭");
//		} else if(str.matches("^[\\w]+\\.gif")){
//			System.out.println("gif 매칭");
//		} else if(str.matches("^[\\w]+\\.PNG")) {
//			System.out.println("PNG 매칭");
//		} else if(str.matches("^[\\w]+\\.txt")) {
//			System.out.println("txt 매칭");
//		}else {
//			System.out.println("유효하지 않은 파일 형식입니다");
//		}
...
//		}
		...
		String result = message.replaceAll("[\\d]", ""); // 숫자제거
